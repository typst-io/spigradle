...
- **Implementation**: [`SubclassDetection`](https://docs.typst.io/spigradle/3.6.0/spigradle/io.typst.spigradle/-subclass-detection/index.html) task
...
| spigradle()       | io.typst:spigradle:$version                      | 3.6.0   | mavenCentral()           |
