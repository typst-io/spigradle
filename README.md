...
- [Description file](https://docs.typst.io/spigradle/3.4.0/spigradle/io.typst.spigradle.spigot/-spigot-extension/index.html)
...
| spigradle()       | io.typst:spigradle:$version                      | 3.4.0   | mavenCentral()           |
