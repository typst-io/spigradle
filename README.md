...
- [Description file](https://docs.typst.io/spigradle/3.2.1/spigradle/io.typst.spigradle.spigot/-spigot-extension/index.html)
...
| spigradle()       | io.typst:spigradle:$version                      | 3.2.1   | mavenCentral()           |
