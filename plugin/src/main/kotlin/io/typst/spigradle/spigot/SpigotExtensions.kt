 ...
 */
fun RepositoryHandler.spigotmc(configure: MavenArtifactRepository.() -> Unit = {}) =
    maven(SpigotRepositories.SPIGOT_MC.address, configure)

/**
 * The repo shortcut for [papermc][SpigotRepositories.PAPER_MC], related with Paper.
 */
fun RepositoryHandler.papermc(configure: MavenArtifactRepository.() -> Unit = {}) =
    maven(SpigotRepositories.PAPER_MC.address, configure)

/**
 * The repo shortcut for [protocolLib][SpigotRepositories.PROTOCOL_LIB], related with ProtocolLib.
 */
fun RepositoryHandler.protocolLib(configure: MavenArtifactRepository.() -> Unit = {}) =
    maven(SpigotRepositories.PROTOCOL_LIB.address, configure)
 ...
 */
fun RepositoryHandler.enginehub(configure: MavenArtifactRepository.() -> Unit = {}) =
    maven(SpigotRepositories.ENGINE_HUB.address, configure)

/**
 * The repo shortcut for [codemc][SpigotRepositories.CODE_MC], related with bStats, bStatsLite.
 */
fun RepositoryHandler.codemc(configure: MavenArtifactRepository.() -> Unit = {}) =
    maven(SpigotRepositories.CODE_MC.address, configure)
 ...
 */
fun RepositoryHandler.enderZone(configure: MavenArtifactRepository.() -> Unit = {}) =
    maven(SpigotRepositories.ENDER_ZONE.address, configure)
 ...
 */
fun RepositoryHandler.frostcast(configure: MavenArtifactRepository.() -> Unit = {}) =
    maven(SpigotRepositories.FROSTCAST.address, configure)
...
fun DependencyHandler.spigotmc(artifactId: String, version: String? = null) =
    "${SpigotDependencies.SPIGOT.dependency.group}:$artifactId:${version ?: SpigotDependencies.SPIGOT.dependency.version}"
