...
```groovy
plugins {
    id 'io.typst.spigradle.base' version '3.7.3'
    id 'java'
}
...
dependencies {
    ...
    implementation("io.typst.spigradle:io.typst.spigradle.gradle.plugin:3.7.3")
    implementation("io.typst.spigradle.bungee:io.typst.spigradle.bungee.gradle.plugin:3.7.3")
}
```
