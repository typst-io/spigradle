...
```groovy
plugins {
    id 'io.typst.spigradle.base' version '4.0.0'
    id 'java'
}
...
dependencies {
    ...
    implementation("io.typst.spigradle:io.typst.spigradle.gradle.plugin:4.0.0")
    implementation("io.typst.spigradle.bungee:io.typst.spigradle.bungee.gradle.plugin:4.0.0")
}
```
