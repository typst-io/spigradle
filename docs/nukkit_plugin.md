...
```groovy
plugins {
    id 'io.typst.spigradle.nukkit' version '3.7.0'
}
```
Kotlin DSL
...
### nukkit - [NukkitExtension](https://docs.typst.io/spigradle/3.7.0/spigradle/io.typst.spigradle.nukkit/-nukkit-extension/index.html)
...
### detectNukkitMain - [SubclassDetection](https://docs.typst.io/spigradle/3.7.0/spigradle/io.typst.spigradle/-subclass-detection/index.html)
...
### generateNukkitDescription - [YamlGenerate](https://docs.typst.io/spigradle/3.7.0/spigradle/io.typst.spigradle/-yaml-generate/index.html)
