...
```groovy
plugins {
    id 'io.typst.spigradle.bungee' version '3.5.2'
}
```
Kotlin DSL
...
### bungee - [BungeeExtension](https://docs.typst.io/spigradle/3.5.2/spigradle/io.typst.spigradle.bungee/-bungee-extension/index.html)
...
### detectBungeeMain - [SubclassDetection](https://docs.typst.io/spigradle/3.5.2/spigradle/io.typst.spigradle/-subclass-detection/index.html)
...
### generateBungeeDescription - [YamlGenerate](https://docs.typst.io/spigradle/3.5.2/spigradle/io.typst.spigradle/-yaml-generate/index.html)
