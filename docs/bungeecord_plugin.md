...
```groovy
plugins {
    id 'io.typst.spigradle.bungee' version '3.2.0'
}
```
Kotlin DSL
...
buildscript {
    ...
    dependencies {
        classpath 'io.typst:spigradle:3.2.0'
    }
}
...
### bungee - [BungeeExtension](https://docs.typst.io/spigradle/3.2.0/spigradle/io.typst.spigradle.bungee/-bungee-extension/index.html)
...
### detectBungeeMain - [SubclassDetection](https://docs.typst.io/spigradle/3.2.0/spigradle/io.typst.spigradle/-subclass-detection/index.html)
...
### generateBungeeDescription - [YamlGenerate](https://docs.typst.io/spigradle/3.2.0/spigradle/io.typst.spigradle/-yaml-generate/index.html)
