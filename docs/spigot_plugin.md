...
kdoc(javadoc): [SpigotPlugin.kt](https://docs.typst.io/spigradle/3.5.2/spigradle/io.typst.spigradle.spigot/-spigot-plugin/index.html)
...
buildscript {
    ...
    dependencies {
        classpath 'io.typst:spigradle:3.5.2'
    }
}
...
### spigot extension - [SpigotExtension](https://docs.typst.io/spigradle/3.5.2/spigradle/io.typst.spigradle.spigot/-spigot-extension/index.html)
...
### debugSpigot extension - [DebugExtension](https://docs.typst.io/spigradle/3.5.2/spigradle/io.typst.spigradle.debug/-debug-extension/index.html)
...
### detectSpigotMain - [SubclassDetection](https://docs.typst.io/spigradle/3.5.2/spigradle/io.typst.spigradle/-subclass-detection/index.html)
...
### generateSpigotDescription - [YamlGenerate](https://docs.typst.io/spigradle/3.5.2/spigradle/io.typst.spigradle/-yaml-generate/index.html)
